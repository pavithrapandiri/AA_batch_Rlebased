...
public class Void_ACHPP_CCK_2tendertypes extends AA_PDL {

	
	

	public static void Void_ACHPP_CCK_2tendertypes_Cash(String SSN,String FileName) throws Exception{
	...
	public static void Void_ACHPP_CCK_2tendertypes_OriginalTender(String SSN,String FileName) throws Exception{
	...
	public static void Void_ACHPP_CCK_2tendertypes_Checktender(String SSN,String FileName) throws Exception{
...

		{
...

			{
				...
				{
					test.log(LogStatus.PASS, "Tender types are Cash and Original Tender ");
				}
