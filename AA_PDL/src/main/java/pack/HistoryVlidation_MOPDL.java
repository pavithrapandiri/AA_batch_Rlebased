...
public class HistoryVlidation_MOPDL  extends AA_PDL{

	
	public  static void HistoryVlidation_MOPDL(String SSN,String FileName) throws Exception
	{
		...
		{	
			...
			if(SSN.equals(RegSSN))
			{
				...
				String PrincipalBalance = driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[3]/table/tbody/tr[16]/td/span[2]")).getText();
...
//                                                            //*[@id="transactionHistoryTable"]/tbody/tr/td[3]/table/tbody/tr[17]/td/span[2]
				String FeeDue = driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[3]/table/tbody/tr[17]/td/span[2]")).getText();
				...
				else
				{
				  ...
				  //                                          
				String PayOffAMT = driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[3]/table/tbody/tr[20]/td/span[2]")).getText();
				...
				// //*[@id="transactionHistoryTable"]/tbody/tr/td[3]/table/tbody/tr[22]/td/span/span// 25
				///                                                     //*[@id="transactionHistoryTable"]/tbody/tr/td[3]/table/tbody/tr[23]/td/span/span
				String PrincipalPaidToDate = driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[3]/table/tbody/tr[24]/td/span/span")).getText();
				...
				String FeePaidToDate = driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[3]/table/tbody/tr[24]/td/span/span")).getText();
...
//                                                                 //*[@id="transactionHistoryTable"]/tbody/tr/td[4]/table/tbody/tr[2]/td/span[2]
				...
				//                                                      /html/body/table/tbody/tr/td/table/tbody/tr/td/form/table[3]/tbody/tr[2]/td[7]
					...
					{
						String ACHType = driver.findElement(By.xpath("//*[@id='achHistoryTable']/tbody/tr[2]/td[2]")).getText();
						...
						String Transactions = driver.findElement(By.xpath("//*[@id='achHistoryTable']/tbody/tr[2]/td[3]")).getText();
						...
						String ACHStatus = driver.findElement(By.xpath("//*[@id='achHistoryTable']/tbody/tr[2]/td[5]")).getText();
						...
						String ACHAmt = driver.findElement(By.xpath("//*[@id='achHistoryTable']/tbody/tr[2]/td[6]")).getText();
						...
						test.log(LogStatus.PASS, "Check Account number is ::"+CheckAcountNo);
						/*if(ACH_check_acc_no.equalsIgnoreCase(CheckAcountNo))
						{
							test.log(LogStatus.PASS, "check_acc_no->Expected value:"+ACH_check_acc_no +"; == Actual value:"+CheckAcountNo);
						}
						else
						{
							test.log(LogStatus.FAIL, "check_acc_no->Expected value:"+ACH_check_acc_no +"; not equals to Actual value:"+CheckAcountNo);	
