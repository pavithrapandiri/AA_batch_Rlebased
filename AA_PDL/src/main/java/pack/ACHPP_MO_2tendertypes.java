...
public class ACHPP_MO_2tendertypes extends AA_PDL {
	...
	/*			String Refno1 = TestData.getCellData(sheetName,"Refno1",row);
				...
				String pmtamt3 = String.valueOf(pmtamt2);*/
				 ...
				 DecimalFormat df = new DecimalFormat("0.00");
			      ...
			      //double pmtamt1 = Double.parseDouble(PaymentAmt);
			
			        float pmtamt1 = Float.parseFloat(PaymentAmount);
					/*	double pmtamt2 = pmtamt1 * PerAmt;*/
			        float pmtamt2 = (float) 233.00;
						//test.log(LogStatus.PASS, pmtamt2 + ": is :" + PerAmt + ": of Total Default Amount");
					
			        float pmtamt4 =pmtamt1-pmtamt2;
			
					//	String pmtamt5 = String.valueOf(val);
						String pmtamt5 =df.format(pmtamt4);
						//String pmtamt3 = String.valueOf(pmtamt2);
						String pmtamt3 =df.format(pmtamt2);
				String SSN4 ="1"+SSN1;
					...
					driver.findElement(By.name("transactionDataBean.tenderAmtFirst")).sendKeys(pmtamt5);
					test.log(LogStatus.PASS, "Tender Type 1 AMT is ::"+pmtamt5);
					...
					driver.findElement(By.name("transactionDataBean.tenderAmtSecond")).sendKeys(pmtamt3);
					test.log(LogStatus.PASS, "Tender Type 2 AMT is ::"+pmtamt3);
	...
	public static void ACHPP_MO_2tendertypes_DiffNumbers_WithHighAmt(String SSN,String FileName) throws Exception{
