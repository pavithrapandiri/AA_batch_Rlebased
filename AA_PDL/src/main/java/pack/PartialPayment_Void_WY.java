...
public class PartialPayment_Void_WY extends AA_PDL{


	public static void PartialPayment_Void_WY(String SSN,String FileName) throws Exception{
		...
		{	
			...
			if(SSN.equals(RegSSN))
			{
				...
				if(ProductID.equals("PDL"))
				{
					...
					//                                       /html/body/form[1]/table/tbody/tr/td/table/tbody/tr[3]/td[2]/table/tbody/tr[3]/td/table/tbody/tr[3]/td[1]
	...
	/*				String Pmt= driver.findElement(By.xpath("/html/body/form[1]/table/tbody/tr/td/table/tbody/tr[3]/td[2]/table/tbody/tr[3]/td/table/tbody/tr[3]/td[1]")).getText();						
	...
	public static void PartialPayment_Void_WY_CheckTenderDetails(String SSN,String FileName) throws Exception{
		...
		{	
			...
			if(SSN.equals(RegSSN))
			{
				...
				driver.switchTo().frame("main");
				try{
				String tendertype1= driver.findElement(By.xpath("//*[@id='tenderType1']/td[2]")).getText();						
				test.log(LogStatus.PASS, "Tender type1 is  ::"+tendertype1);
				
				String CCMOnbr1= driver.findElement(By.xpath("//*[@id='ccmoNbr1']/td[2]")).getText();						
				test.log(LogStatus.PASS, "CC/MO number1 is  ::"+CCMOnbr1);
				
				String tenderAmt1= driver.findElement(By.xpath("//*[@id='amt1']/td[2]")).getText();						
				test.log(LogStatus.PASS, "Tender Amt1 is  ::"+tenderAmt1);
				
				String tendertype2= driver.findElement(By.xpath("//*[@id='tenderType2']/td[2]")).getText();						
				test.log(LogStatus.PASS, "Tender type2 is  ::"+tendertype2);
				
				String CCMOnbr2= driver.findElement(By.xpath("//*[@id='ccmoNbr2']/td[2]")).getText();						
				test.log(LogStatus.PASS, "CC/MO Number2  is  ::"+CCMOnbr2);
				
				String tenderAmt2= driver.findElement(By.xpath("//*[@id='amt2']/td[2]")).getText();						
				test.log(LogStatus.PASS, "Tender Amt2 is  ::"+tenderAmt2);
				}
				catch(Exception e){
	...
	public static void PartialPayment_Void_WY_CheckTenderDetails_OriginalTender(String SSN,String FileName) throws Exception{
		...
		{	
			...
			if(SSN.equals(RegSSN))
			{
				...
				if(ProductID.equals("PDL"))
				{
					driver.findElement(By.name("transactionDataBean.disbursementType")).sendKeys("Original Tender");
