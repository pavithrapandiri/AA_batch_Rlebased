...
public class EPP_FL_ILP extends AA_CO_ILP{

	
	public static void EPP_ILP(String SSN,String FileName) throws Exception{
		...
		{	
			...
			if(SSN.equals(RegSSN))
			{
				...
				driver.findElement(By.name("abaNbr")).sendKeys("121000248");
				test.log(LogStatus.PASS,"ABA number selected as ::111111118");

				driver.findElement(By.name("chkgAcctNbr")).sendKeys(ChkgAcctNbr);
				test.log(LogStatus.PASS,"Checking Account number entered as"+ChkgAcctNbr);
