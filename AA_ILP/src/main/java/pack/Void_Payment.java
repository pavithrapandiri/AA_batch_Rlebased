...
public class Void_Payment extends AA_CO_ILP{

	public static void Void_Payment(String SSN, String FileName) throws Exception {
...
/*
				...
				if (ProductID.equals("ILP")) {
					...
					driver.findElement(By.xpath("/html/body/form[1]/table/tbody/tr[10]/td/table/tbody/tr/td[3]/input"))
							.click();
