...
public class Void_PaymentPlanPayment extends AA_CO_ILP{

	public static void Void_PaymentPlanPayment(String SSN, String FileName) throws Exception {
		...
		for (int row = 2; row <= lastrow; row++) {
			...
			if (SSN.equals(RegSSN)) {
				...
				test.log(LogStatus.PASS,
						"<FONT color=green style=Arial> ----------- Void Payment plan Payment -----------");
