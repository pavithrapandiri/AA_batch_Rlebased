...
public class Refinance_Void extends AA_ILP{
 
	public static void Refinance_Void(String SSN, String FileName) throws Exception {
			...
			if (SSN.equals(RegSSN)) {
				...
				if (ProductID.equals("ILP")) {
					...
					if (ProductID.equals("ILP")) {
						...
						{
							test.log(LogStatus.PASS, "Refinance Void  is Completed Successfully ");
							driver.findElement(By.xpath("//*[@id='totPart']/tbody/tr/td/table/tbody/tr/td/table[2]/tbody/tr/td/input[1]")).click();
						} else {
							test.log(LogStatus.FAIL, "Refinance Void is not Completed Successfully ");
						}
