...
public class NewLoan_ILP_Prod extends AA_CO_ILP{
 
	public static void NewLoan_ILP_Prod(String SSN, String FileName,String NegAmt) throws Exception {
...
*/
	...
	public static void NewLoan_OK_ILP_Prod(String SSN, String FileName,String NegAmt) throws Exception {
